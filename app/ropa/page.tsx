...
function getEffectiveProductStatus(
   ...
   * manuales y no dependen automáticamente del stock.
   */
  if (
    storedStatus === "DRAFT" ||
  ...
  /*
   * Disponible y Agotado se calculan siempre
   * utilizando el stock real de las variantes activas.
   */
  return totalStock > 0
    ? "AVAILABLE"
    : "SOLD_OUT";
